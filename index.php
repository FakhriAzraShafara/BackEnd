  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin Data Penduduk</a>
        </div>
      </div>
                ...
                <form method="post" action="terima.php">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="warga_negara" id="warga_negara" value="WNI">
                                <label class="form-check-label">WNI</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="warga_negara" id="warga_negara" value="WNA">
